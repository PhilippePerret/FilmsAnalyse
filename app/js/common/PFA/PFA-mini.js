...
, DATA_STT_NODES: {
    ...
    , preamb: {hname: 'Préambule', shortHname: 'Préamb.', cZone:'[0,iem24]', next:'incPer', last: 'desine', tolerance: 'after', requirity:5}
    , incPer: {hname: 'Incident perburbateur', shortHname: 'Inc.Pert.', cZone:'[iem24,douzi]', next:'incDec', tolerance: 'before', requirity:7}
    , incDec: {hname: 'Incident déclencheur', shortHname: 'Inc.Déc.', cZone:'[douzi,quart-douzi]', next:'zone_r', tolerance: 'before', requirity:10}
    , zone_r: {hname: 'Zone de refus', shortHname: 'Zone R.', cZone:'[quart-douzi,quart-iem24]', next:'pivot1', tolerance: 'before', requirity:4}
    , pivot1: {hname: 'Pivot 1', shortHname: 'Pvt 1', cZone: '[quart-iem24,quart]', next:'act1d1', tolerance: 'none', requirity:9}
    ...
    , act1d1: {hname: '1ère action', shortHname: '1ère action', cZone:'[quart,quart+iem24]', next:'tiers1', tolerance:'none', requirity:4}
    , tiers1: {hname: 'Premier Tiers', shortHname: '1/3', cZone:'[tiers-iem24,tiers+iem24]', next: 'cledev', tolerance:'none', requirity:3}
    , cledev: {hname: 'Clé de voûte', shortHname: 'C.d.V.', cZone:'[moiti-iem24,moiti+iem24]', next: 'act1d2', tolerance:'none', requirity:9}
