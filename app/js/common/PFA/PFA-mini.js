...
const PFA = {
  ...
  , DATA_STT_NODES: {
      ...
      , preamb: {hname: 'Préambule', shortHname: 'Préamb.', cZone:'[0,"incPer"]', cZoneAlt:'[0,huiti]', next:'incPer'}
      , incPer: {hname: 'Incident perburbateur', shortHname: 'Inc.Perturb.', cZone:'[douzi,douzi+iem24]', next:'incDec'}
      , incDec: {hname: 'Incident déclencheur', shortHname: 'Inc.Déc.', cZone:'["incPer","zone_r"]', cZoneAlt:'[iem24,quart-iem24]', next:'zone_r'}
      , zone_r: {hname: 'Zone de refus', shortHname: 'Zone R.', cZone:'[quart-douzi,"pivot1"]', next:'pivot1'}
      , pivot1: {hname: 'Pivot 1', shortHname: 'Pvt 1', cZone: '[quart-iem24,quart]', next:'actio1'}
      , DEV1:   {hname: 'DÉVELOPPEMENT (1ère partie)', shortHname: 'DÉV. Part 1', cZone:'[quart,moiti]', main: true, next: 'DEV2'}
      , actio1: {hname: 'Première action', shortHname: '1ère action', cZone:'[quart,quart+iem24]', next:'tiers1'}
      ...
      , DNOU:   {hname: 'DÉNOUEMENT', shortHname: 'DÉNOUE.', cZone:'[tresQ,duree]', main: true, next: null, first: 'EXPO'}
      , crisis: {hname: 'Crise', shortHname: 'Crise', cZone:'[tresQ+iem24,"climax"]', cZoneAlt:'[tresQ-douzi,tresQ]', next: 'climax'}
      , climax: {hname: 'Climax', shortHname: 'Climax', cZone:'[duree-huiti,duree]', next: 'desine'}
      , desine: {hname: 'Désinence', shortHname:'Désin.', cZone:'["climax",duree]', next: null, first: 'preamb'}
    }
}
