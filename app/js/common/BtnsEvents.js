...
static get fwindow(){return this._fwindow||defP(this,'_fwindow', new FWindow(this,{id: 'buttons-new-event', container: $('#section-footer'), y: 0, x: 40, class: 'no-user-selection'}))}
